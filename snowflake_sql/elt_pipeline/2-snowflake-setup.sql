...
-- 2. ELT Landing Schema
CREATE OR REPLACE SCHEMA DEV_LANDING_ADF.AIRBNB;
CREATE OR REPLACE SCHEMA DEV_GOLD_ADF.AIRBNB;

-- 3. Landing Table Creation
