...
CREATE SCHEMA IF NOT EXISTS DEV_DBTCENTRAL.DATAHUB_GOVERN;

-- 3. Create object for dbt project
CREATE OR REPLACE DBT PROJECT DEV_DBTCENTRAL.DATAHUB_REFINERY.DATAHUB_DBT_MODELS
  FROM 'snow://workspace/"USER$"."PUBLIC"."snowflake-dbt-workspace"/versions/head/datahub_refinery'
  COMMENT = 'Snowflake DBT Project for datahub_refinery'
;

CREATE OR REPLACE DBT PROJECT DEV_DBTCENTRAL.DATAHUB_GOVERN.DATAHUB_DBT_MODELS
...
SHOW VERSIONS IN DBT PROJECT DEV_DBTCENTRAL.DATAHUB_GOVERN.DATAHUB_DBT_MODELS;
