...
ALTER TABLE DEV_BRONZE_ADF.AIRBNB_DMP."AirBnBReviews" MODIFY COLUMN "reviewer_name"
SET MASKING POLICY DEV_DBTGOVERN.POLICIES.COLUMN_VARCHAR_MASKING_POLICY
    USING("reviewer_name")
;

ALTER TABLE DEV_BRONZE_ADF.AIRBNB_DMP."AirBnBReviews" MODIFY COLUMN "comments"
SET MASKING POLICY DEV_DBTGOVERN.POLICIES.COLUMN_VARCHAR_MASKING_POLICY
    USING("comments")
;

DESC TABLE DEV_BRONZE_ADF.AIRBNB_DMP."AirBnBReviews";

SELECT * FROM TABLE(
    RESULT_SCAN('01c13c19-0001-6e8d-000c-f12e000dccf2')
);
...
SELECT * FROM DEV_BRONZE_ADF.AIRBNB_DMP."AirBnBReviews" LIMIT 5;