...
SELECT '7_platinum_dt'  AS context, COUNT(*), MIN("DATE"), MAX("DATE") FROM DEV_PLATINUM_ADF.AIRBNB."FACT_AIRBNB_REVIEWS_RAP_DT"
;
...
SELECT * FROM (SELECT '7_platinum_dt' AS context, "ID"::VARCHAR, "REVIEWER_NAME", "COMMENTS" FROM DEV_PLATINUM_ADF.AIRBNB."FACT_AIRBNB_REVIEWS_DMP_DT" WHERE "REVIEWER_NAME" = 'Steve' LIMIT 1)
;
...
SELECT * FROM (SELECT '7_platinum_dt' AS context, "ID"::VARCHAR, "REVIEWER_NAME", "COMMENTS" FROM DEV_PLATINUM_ADF.AIRBNB."FACT_AIRBNB_REVIEWS_TAG_COLUMN_DT" LIMIT 1)
;
...
SELECT * FROM (SELECT '7_platinum_dt' AS context, "ID"::VARCHAR, "REVIEWER_NAME", "COMMENTS" FROM DEV_PLATINUM_ADF.AIRBNB."FACT_AIRBNB_REVIEWS_TAG_TABLE_DT" LIMIT 1)
;