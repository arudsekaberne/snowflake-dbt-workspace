...
ALTER TABLE DEV_BRONZE_ADF.AIRBNB_TEST."AirBnBReviews_v" DROP ALL ROW ACCESS POLICIES;
ALTER TABLE DEV_BRONZE_ADF.AIRBNB_TEST."AirBnBReviews_sv" DROP ALL ROW ACCESS POLICIES;
...
-- 4. Run dbt models
--select +path:models/bronze/airbnb_test
...
SELECT MIN("date"), MAX("date") FROM DEV_BRONZE_ADF.AIRBNB."AirBnBReviews";  -- (No RAP)
SELECT MIN("date"), MAX("date") FROM DEV_BRONZE_ADF.AIRBNB_TEST."AirBnBReviews";
SELECT MIN("date"), MAX("date") FROM DEV_BRONZE_ADF.AIRBNB_TEST."AirBnBReviews_v";
SELECT MIN("date"), MAX("date") FROM DEV_BRONZE_ADF.AIRBNB_TEST."AirBnBReviews_sv";
SELECT MIN("date"), MAX("date") FROM DEV_BRONZE_ADF.AIRBNB_TEST."AirBnBReviews_dt";